...
import 'package:flutter_application_1/datas/siteup/siteup.dart';
...
class LoginModel {
  ...
  static Future<dynamic> signup(
    ...
    Response response =
        await DioInstance.instance().post(path: "/auth/signup", data: data);

    Siteup responseData = Siteup.fromJson(response.data);
    if (responseData != null) {
      return responseData.data;
    }
  }
